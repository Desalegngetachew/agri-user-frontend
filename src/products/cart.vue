                            ...
                            <div class="" v-if="item.user_email==cart_email">
                                <div class="p-4">
                                    <div class="flex flex-row space-x-20">
                                        ...
                                        <button  @click.prevent="getOrderedProductByIdforConfirm(item.order_id)">Confirm</button>
                                        <button  @click.prevent="getOrderedProductById(item.order_id)">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
const getProducts = async () => {
    try {
        ...
        console.log(confirmDisplay.value[datas.value.order_id]);
