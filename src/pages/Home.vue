                                ...
                                <div class=" flex flex-col">
                                    <div class=" flex flex-col gap-2 hover:shadow-xl hover:cursor-pointer   h-74 w-60  p-4 shadow-md">
                                        ...
                                        <!-- <div class="rating flex justify-center">
                                            <input type="radio" name="star" id="star1"><label for="star1"><font-awesome-icon icon="fa-sharp fa-solid fa-star" /></label>
                                            <input type="radio" name="star" id="star2"><label for="star2"><font-awesome-icon icon="fa-sharp fa-solid fa-star" /></label>
                                            <input type="radio" name="star" id="star3"><label for="star3"><font-awesome-icon icon="fa-sharp fa-solid fa-star" /></label>
                                            <input type="radio" name="star" id="star4"><label for="star4"><font-awesome-icon icon="fa-sharp fa-solid fa-star" /></label>
                                            <input type="radio" name="star" id="star5"><label for="star5"><font-awesome-icon icon="fa-sharp fa-solid fa-star" /></label>
                                        </div> -->
...
// const getRate = async (order_email) => {  // get rate by id for email
//     try {
//      const rate = await axios.get(`http://localhost:5000/favorite/${order_email}`);
//      rateCounter.value = rate.data.favorite_no;
//      console.log(rateCounter.value);
//  if(rateCounter.value==1){
//     console.log('color changed to green')
//    activeColor = ref('green' );
//  }
//  else{
//    activeColor = ref('white' );
//  }
//     } catch (err) {
//     }
// }
